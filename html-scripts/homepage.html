  ...
  <body>
    ...
    <header>
      <nav>
        ...
        <ul class="nav-links">
          <li class="nav-link">
            <a href="homepage.html" class="current-page" aria-current="page"
              >Home</a
            >
          </li>
          <li class="nav-link">
      ...
      <section class="introduction-container">
        ...
        <p class="intro-desc">
          <span class="mobile-text"
            >Welcome to MareBella — where the sea whispers and time stands
          ...
          <article class="room-card">
            ...
            <div class="price-and-book-box">
              ...
              <a
                href="rooms.html"
                class="view-details"
                aria-label="View details for Classic Mediterranean Twin room"
                >View details</a
              >
            </div>
          </article>
          ...
          <article class="room-card">
            ...
            <div class="price-and-book-box">
              ...
              <a
                href="rooms.html"
                class="view-details"
                aria-label="View details for Premium Sea View Suite"
                >View details</a
              >
            </div>
          </article>
